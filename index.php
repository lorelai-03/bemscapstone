    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white" data-aos="fade-down">
        <div class="container">
            <a href="index.php" class="logo text-center logo-light">
                <span class="logo-lg">
                     <img src="img/nem.png" alt="" height="60px">
                </span>
            </a>
...
<style>
    h1 {
        color: white;
        text-shadow: 4px 4px 10px rgba(0, 0, 0, 1); /* Dark black shadow */
    }
</style>
                    <h1 class="display-4" data-aos="zoom-in">BARANGAY CORAL NI BACAL CERTIFICATE REQUEST & <br>
    ...
    alert("Please register to use this service");
			...
			<img src="https://img.icons8.com/?size=100&id=42844&format=png&color=000000">
                <i class="uil uil-chart-pie text-primary font-24"></i>
                    ...
                    <h4 class="mt-3" onclick="showWarning()">Certificates</h4>
                    <p class="text-muted mt-2 mb-0" onclick="showWarning()">
            ...
            <div class="card-body">
                ...
                <form id="registrationForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="firstn" name="firstn" required style="color: black; border-radius: 8px; border: 2px solid black;" oninput="validateInput(event)"> 
                    </div>
                    <!-- Last Name -->
                    <div class="form-group mb-3">
                        <label for="lastn" class="font-weight-bold">Last Name</label>
                        <input type="text" class="form-control" id="lastn" name="lastn" required style="color: black; border-radius: 8px; border: 2px solid black;" oninput="validateInput(event)">
                    </div>
                    <!-- Middle Initial -->
                    <div class="form-group mb-3">
                        <label for="middlei" class="font-weight-bold">Middle Initial</label>
                        <input type="text" class="form-control" id="middlei" name="middlei" style="color: black; border-radius: 8px; border: 2px solid black;" oninput="validateInput(event)">
                    </div>
                    <!-- Gender -->
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="householdResidents" name="householdResidents" rows="4" placeholder="Enter the names of household residents" style="color: black; border-radius: 8px; border: 2px solid black;" oninput="validateInput(event)"></textarea>
                    </div>
                    <!-- Profile Image -->
                    <div class="form-group mb-3">
                        <label for="image" class="font-weight-bold">ID Image</label>
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.status === 'success') {
                    ...
                    // Show an error message for contact duplication or any other error
                    Swal.fire({
                        icon: 'error',
...
<script>
  function validateInput(event) {
    ...
    input.value = value.replace(/[^A-Za-z]/g, ''); // Remove anything that's not a letter
  }
</script>
