...
$sourceDir = 'C:\\xampp\\htdocs\\bemscapstone\\admin\\uploads\\events';
$destDir1 = 'C:\\xampp\\htdocs\\bemscapstone\\residents\\uploads\\events';
$destDir2 = 'C:\\xampp\\htdocs\\bemscapstone\\officials\\uploads\\events';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        // Image upload logic
        $image = $_FILES['image'];
        $upload_dir = 'uploads/events/'; // Directory where images will be stored
        ...
        if (in_array($file_type, $allowed_types)) {
            ...
            if (move_uploaded_file($image['tmp_name'], $image_path)) {
                ...
                copyFiles('C:\\xampp\\htdocs\\bemscapstone\\admin\\uploads\\events', 
                          ['C:\\xampp\\htdocs\\bemscapstone\\residents\\uploads\\events', 
                           'C:\\xampp\\htdocs\\bemscapstone\\officials\\uploads\\events'], 
                          $image_name);
            } else {
                echo json_encode([
                    'success' => false,
