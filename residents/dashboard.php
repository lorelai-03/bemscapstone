...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.view-btn', function() {
            ...
            var time = $(this).data('time'); // Expected in 24-hour format like '19:55:00'
            ...
            // Convert time to 'h:i A' format (12-hour format with AM/PM)
            var formattedTime = formatTimeTo12Hour(time);
            $('#viewTime').text(formattedTime);
