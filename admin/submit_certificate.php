...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Define source and destination directories for file copying (using relative paths)
    $sourceDir = __DIR__ . '/uploads/certificates';  // Correct source directory
    $destDir1 = __DIR__ . '/../residents/uploads/certificates';  // Correct destination directory
        ...
        if (in_array($file['type'], $allowedFileTypes)) {
            ...
            if ($file['size'] <= $maxFileSize) {
                ...
                if (move_uploaded_file($file['tmp_name'], $filePath)) {
                    ...
                    $username = "u320463645_coralnibacal";
                    $password = "Bacalnicoral26*";
                    $dbname = "u320463645_coralnibacal";  // Replace with your actual database name
